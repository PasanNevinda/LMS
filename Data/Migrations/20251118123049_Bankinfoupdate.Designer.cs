...
namespace LMS.Data.Migrations
{
    ...
    [Migration("20251118123049_Bankinfoupdate")]
    partial class Bankinfoupdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.Models.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS.Models.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS.Models.Entities.Course", b =>
                {
                    ...
                    b.Property<string>("TargetAudiance")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LMS.Models.Entities.InstructorPayout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS.Models.Entities.PaymentTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS.Models.Entities.PlatformFinance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("TotalPaidToInstructors")
                        .HasColumnType("decimal(18,2)");

                    b.HasKey("Id");

                    b.ToTable("PlatformFinances");
            ...
            modelBuilder.Entity("LMS.Models.Entities.CartItem", b =>
                {
                    b.HasOne("LMS.Models.Entities.Cart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("LMS.Models.Entities.ContentItem", b =>
                {
                    ...
                    b.HasOne("LMS.Models.Entities.Teacher", null)
                        .WithMany("ContentItems")
            ...
            modelBuilder.Entity("LMS.Models.Entities.Course", b =>
                {
                    b.HasOne("LMS.Models.Entities.Category", "Category")
                        .WithMany("Courses")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("LMS.Models.Entities.Admin", "ReviewedBy")
            ...
            modelBuilder.Entity("LMS.Models.Entities.Enrollment", b =>
                {
                    ...
                    b.HasOne("LMS.Models.Entities.PaymentTransaction", "PaymentTransaction")
                        .WithMany("Enrollments")
